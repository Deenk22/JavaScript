...
function mediaNotas(asignaturas){ // Funcion con asignaturas como parametro.

    let resultado = 0;
    for (const asignatura of asignaturas){ // Una forma de recorrer nuesto array de objetos.
        resultado += capturarNotas(asignatura) // resultado = resultado + nota; > Llamamos a una función
        // que devuelve nota con un valor que hemos introducido por teclado.
    }
...
function capturarNotas(asignatura){
